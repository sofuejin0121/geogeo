...
class User < ApplicationRecord
  ...
  def feed
    ...
    following_user_reposted_micropost_ids      = "SELECT micropost_id FROM reposts
                                                  WHERE user_id IN (#{following_ids}) "
    Micropost.where("id IN (#{following_user_reposted_micropost_ids}) OR user_id IN (#{following_ids})
